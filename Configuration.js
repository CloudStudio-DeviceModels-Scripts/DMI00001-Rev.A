...
function getEndpoints(deviceAddress, endpoints)
{
   ...
   endpoints.addEndpoint("Ts_001", "Sensor de Temperatura", endpointType.temperatureSensor);
   endpoints.addEndpoint("Ts_002", "Sensor Dimmer", endpointType.dimmer);
   endpoints.addEndpoint("Ts_003", "Sensor Color Dimmer", endpointType.colorDimmer);
   endpoints.addEndpoint("Ts_004", "Sensor luminosidad", endpointType.lightSensor);
   endpoints.addEndpoint("Ts_005", "Sensor Cerradura", endpointType.doorLock)
}

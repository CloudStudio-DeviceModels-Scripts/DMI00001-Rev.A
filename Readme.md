...
# Parsing + Configuration Script – DMI_00001 - Rev. A

This **Parsing + Configuration** script is designed for the **DMI_00001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – DMI_00001 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **DMI_00001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
